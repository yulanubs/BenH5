...
public class MyAndroiddevice extends DeviceInfo {

	public MyAndroiddevice(String imei, String imsi, String user_agent,
						   String device_id, String device_type) {
		super(imei, imsi, user_agent, device_id, device_type);
		// TODO Auto-generated constructor stub
	}

	public MyAndroiddevice() {
		super("", "", "android", "", "android");
	}

	protected String PromotionSales_CACHE_PATH = "/BenH5/Cache";
	protected String PromotionSales_DOWNLOAD_PATH = "/BenH5/download";
